...
$query = "SELECT id, nombre, descripcion, precio, imagen, cantidad FROM pasteles WHERE categoria = 'Cupcake'";
...
<head>
    ...
    <title>Cupcakes - Delicias Gourmet</title>
...
<main>
        ...
        <h2 class="card-titulo">Cupcakes</h2>
        <div class="card-tarjetas">
            ...
            if (mysqli_num_rows($resultado) > 0) {
                ...
                echo "<p class='no-disponible'>No hay cupcakes disponibles.</p>";
            }
