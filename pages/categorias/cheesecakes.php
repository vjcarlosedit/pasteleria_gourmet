...
$query = "SELECT id, nombre, descripcion, precio, imagen, cantidad FROM pasteles WHERE categoria = 'Cheesecake'";
...
<head>
    ...
    <title>Cheesecake - Delicias Gourmet</title>
...
<main>
    <section class="card-section">
        <h2 class="card-titulo">Cheesecake</h2>
        <div class="card-tarjetas">
            ...
            if (mysqli_num_rows($resultado) > 0) {
                ...
                echo "<p class='no-disponible'>No hay pasteles disponibles.</p>";
            }
